-- the queries generated by postgrest can be inspected using postgres logs;
-- see: http://postgrest.org/en/v5.2/admin.html#debugging
-- command: sudo less +F /var/lib/postgresql/VERSION/main/pg_log/postgresql-YYYY-MM-DD.log 


sudo less +F /var/lib/postgresql/10/main/pg_log/postgresql-2019-09-13_000000.log
